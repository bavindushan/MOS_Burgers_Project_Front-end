...
export function getAdminPassword() {
    return adminPassword[0]; // Return the first element of the array
}

// Function to set a new admin password
export function setAdminPassword(newPassword) {
    adminPassword[0] = newPassword; // Update the password in the array
}
